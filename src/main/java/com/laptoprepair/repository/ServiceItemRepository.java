 ...
 * Provides methods for performing CRUD operations and custom queries related to service items.
 */
...
public interface ServiceItemRepository extends JpaRepository<ServiceItem, UUID> {
       ...
       /**
        * Checks if a service item with the given name already exists, excluding a specific ID.
        * This is used for uniqueness checks during updates.
        * @param name The name to check.
        * @param id The ID of the service item to exclude from the check.
        * @return true if a service item with the name exists and its ID is not the excluded ID, false otherwise.
        */
        ...
        * @return An Optional containing the active ServiceItem if found, otherwise empty.
        */
