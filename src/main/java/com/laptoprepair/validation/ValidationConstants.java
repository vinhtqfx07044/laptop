...
public final class ValidationConstants {
    ...
    public static final String REQUEST_NAME_SIZE_MSG = "Tên khách hàng phải có từ " + REQUEST_NAME_MIN_LENGTH + "-" + REQUEST_NAME_MAX_LENGTH + " ký tự";
    ...
    public static final String REQUEST_DESCRIPTION_SIZE_MSG = "Mô tả phải có từ " + REQUEST_DESCRIPTION_MIN_LENGTH + "-" + REQUEST_DESCRIPTION_MAX_LENGTH + " ký tự";
