...
/**
 * Configuration class for setting up chat-related beans, including the system prompt, chat memory, and ChatClient.
 */
@Configuration
public class ChatConfig {

    /**
     * Resource containing the system prompt for the chat.
     */
    @Value("classpath:system-prompt.txt")
    private Resource promptResource;

    /**
     * Maximum number of user messages to retain in chat memory.
     */
     ...
     * Uses JdbcChatMemoryRepository with a Postgres dialect if the 'prod' profile is active.
