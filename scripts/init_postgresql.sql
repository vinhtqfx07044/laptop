-- =================================================================================================
-- POSTGRESQL DATA SCRIPT FOR LAPTOP REPAIR APPLICATION
-- This script inserts sample data for both dev and prod PostgreSQL environments
-- =================================================================================================
...
-- Section 2: REQUESTS
-- -------------------------------------------------------------------------------------------------
INSERT INTO request (id, name, phone, email, address, brand_model, appointment_date, description, status, completed_at) VALUES
('aaaaaaaa-aaaa-aaaa-aaaa-000000000001', 'Lê Minh Tuấn', '0901123456', 'tuan.le@email.com', '10 Phan Xích Long, Phú Nhuận, TP.HCM', 'Dell XPS 15 9570', '2025-07-25 10:00:00', 'Máy tính rất nóng khi sử dụng và quạt kêu to bất thường. Cần kiểm tra hệ thống tản nhiệt.', 'SCHEDULED', NULL),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000002', 'Nguyễn Thị Hoa', '0912345678', 'hoa.nguyen@email.com', '25 Nguyễn Thị Minh Khai, Quận 1, TP.HCM', 'HP Envy 13', '2025-07-26 14:00:00', 'Bàn phím bị liệt một vài phím (E, R, T). Không gõ được.', 'QUOTED', NULL),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000003', 'Trần Văn Bình', '0987654321', 'binh.tran@email.com', '300 Lê Văn Sỹ, Quận 3, TP.HCM', 'MacBook Pro 14" M1', '2025-07-27 09:30:00', 'Màn hình bị sọc ngang, hiển thị sai màu. Đã thử khởi động lại nhưng không hết.', 'APPROVE_QUOTED', NULL),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000004', 'Phạm Thị Dung', '0939876543', 'dung.pham@email.com', '50A Trần Hưng Đạo, Quận 5, TP.HCM', 'Lenovo Yoga Slim 7', '2025-07-20 11:00:00', 'Máy không sạc được pin, cắm sạc không có tín hiệu. Đã thử đổi ổ cắm.', 'IN_PROGRESS', NULL),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000005', 'Hoàng Văn Nam', '0945123789', 'nam.hoang@email.com', '123 Nguyễn Văn Cừ, Quận 5, TP.HCM', 'Asus TUF Gaming F15', '2025-07-15 15:00:00', 'Máy chạy rất chậm, mở ứng dụng hay bị treo. Muốn nâng cấp thêm RAM và vệ sinh máy.', 'COMPLETED', '2025-07-18 17:00:00'),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000006', 'Vũ Thị Lan', '0978456123', 'lan.vu@email.com', '88 Võ Văn Tần, Quận 3, TP.HCM', 'Acer Aspire 5', '2025-07-10 16:00:00', 'Máy không kết nối được Wifi, đã thử cài lại driver nhưng không được.', 'CANCELLED', NULL),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000007', 'Đặng Minh Châu', '0905555888', 'chau.dang@email.com', '459 Sư Vạn Hạnh, Quận 10, TP.HCM', 'Microsoft Surface Laptop 4', '2025-06-25 10:30:00', 'Ổ cứng đầy, máy khởi động và chạy ứng dụng rất ì ạch. Cần thay ổ SSD dung lượng lớn hơn.','COMPLETED', '2025-06-27 11:00:00'),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000008', 'Ngô Gia Huy', '0918888999', 'huy.ngo@email.com', '18E Cộng Hòa, Tân Bình, TP.HCM', 'Razer Blade 15', '2025-07-28 13:00:00', 'Chơi game một lúc là máy tự sập nguồn. Nhiệt độ CPU rất cao.',  'QUOTED', NULL),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000009', 'Lý Thu Thảo', '0966777888', 'thao.ly@email.com', '202 Tô Hiến Thành, Quận 10, TP.HCM', 'Dell Latitude 7420', '2025-07-22 15:30:00', 'Làm rơi laptop, vỏ bị móp, bản lề gãy.', 'IN_PROGRESS', NULL),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000010', 'Bùi Anh Dũng', '0922333444', 'dung.bui@email.com', '79/15 Âu Cơ, Tân Bình, TP.HCM', 'HP Spectre X360', '2025-06-15 09:00:00', 'Pin dùng rất nhanh hết, chỉ được khoảng 1 tiếng. Cần thay pin mới.', 'COMPLETED', '2025-06-15 11:30:00'),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000011', 'Đỗ Ngọc Anh', '0908111222', 'anh.do@email.com', '12bis Nguyễn Huệ, Quận 1, TP.HCM', 'MacBook Air M2', '2025-07-29 16:30:00', 'Làm đổ nước vào máy, đã lau khô nhưng không dám bật nguồn. Cần kiểm tra gấp.', 'SCHEDULED', NULL),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000012', 'Mai Tiến Thành', '0913222333', 'thanh.mai@email.com', '56 Thành Thái, Quận 10, TP.HCM', 'LG Gram 17', '2025-07-24 17:00:00', 'Cần cài đặt một số phần mềm đồ họa chuyên dụng.', 'CANCELLED', NULL),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000013', 'Tô Hoài An', '0988999000', 'an.to@email.com', '99 Nguyễn Trãi, Quận 1, TP.HCM', 'Samsung Galaxy Book 3', '2025-07-28 18:00:00', 'Máy không nhận sạc, đã thử dây sạc khác vẫn không được.', 'APPROVE_QUOTED', NULL),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000014', 'Dương Hữu Nghĩa', '0903876543', 'nghia.duong@email.com', '332 Lý Thường Kiệt, Quận 11, TP.HCM', 'MSI Modern 14', '2025-07-01 14:00:00', 'Máy chạy chậm, muốn nâng cấp ổ cứng.', 'COMPLETED', '2025-07-02 16:00:00'),
('aaaaaaaa-aaaa-aaaa-aaaa-000000000015', 'Châu Mỹ Lệ', '0919876543', 'le.chau@email.com', '100 Hùng Vương, Quận 5, TP.HCM', 'Asus Zenbook UX425', '2025-07-23 11:30:00', 'Màn hình bị nhấp nháy liên tục, rất khó chịu.', 'IN_PROGRESS', NULL);
